...
#
#Sunspot Autocomplete lets you use Solr and Sunspot for handy autocompletion of your html text inputs.
#
#=== Features:
#
...
#== Usage
#
#Run the following to generate the assets to your public directory. This will copy jquery.js and solr-autocompleter to your public/javascripts.
#
#  ruby script/generate sunspot_assets
#
# In your solr schema.xml, Make sure that the following field types are present inside the <types> tag:
#
...
#  </fieldType>
#
#Also in your solr schema.xml, Make sure that the following fields are inside inside the <fields> tag.
#
...
ActionView::Base.send :include, Sunspot::Rails::AutocompleteViewHelpers